...
The task list is the primary visual element of the complete multiple tasks pattern. It helps users understand what they need to do, what they have already done, and what is available or locked at each point in the journey.
...
- As part of the complete multiple tasks pattern.
...
The component renders as `<ul class="govuk-task-list">`. Each item is an `<li class="govuk-task-list__item">`. The title and status link via `aria-describedby` — screen readers announce both the task name and its status when focus lands on the title link.
...
| Status | Tag colour |
|--------|------------|
| Completed | Green (`govuk-tag--green`) |
| In progress | Blue (default, no modifier) |
| Not started | Grey (`govuk-tag--grey`) |
...
<ul class="govuk-task-list">
  ...
  <li class="govuk-task-list__item">
    <div class="govuk-task-list__name-and-hint">
      <span aria-describedby="submit-status">Submit and pay</span>
    </div>
...
{{ govukTaskList({
  items: [
    ...
    {
      title: { text: "Choose date of interview" },
      href: "/choose-date",
      status: {
  ...
  items: [
    {
      title: { text: "Check before you start" },
      hint: {
        text: "Eligibility, who can apply and getting an agent to apply for you"
      },
      href: "/eligibility",
      status: {
        tag: { text: "Completed", classes: "govuk-tag--green" }
    ...
    {
      title: { text: "Prepare application" },
      hint: {
        text: "Licence period, contact details and add site manager"
      },
      href: "/prepare",
      status: {
        tag: { text: "In progress" }
    ...
    },
    {
      title: { text: "Apply" },
      hint: {
        text: "Submit and pay for the licence"
      },
      status: {
        text: "Cannot start yet"
      }
  ...
  items: [
    {
      ...
      href: "/your-details",
      status: { tag: { text: "Completed", classes: "govuk-tag--green" } }
    },
    {
...
<h2 class="govuk-heading-m">About your property</h2>
{{ govukTaskList({
  idPrefix: "property",
  items: [
    {
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `tag` | object | No | Options for a Tag component. Use for "Completed", "In progress", "Not started", etc. |
...
The task list component does not have error states. This is a navigation/status display component.
