...
- "You're assuming users will understand 'sort code' — consider testing whether hint text helps, with users who haven't set up a direct debit before."
- "Never test with placeholder content. Participants react to what they read, and fake content gives you fake findings."
- "This prototype only covers the happy path. You won't learn anything about error recovery unless you build the error states."
